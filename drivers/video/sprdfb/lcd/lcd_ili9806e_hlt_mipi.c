...
static LCM_Init_Code init_data[] = {
    ...
    {LCM_SEND(2), {0x53, 0x6c}},                 // 2-Dot Inversion
...
//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
    ...
    {LCM_SEND(2), {0xA1, 0x0c}},  // Gamma 4 /251
    {LCM_SEND(2), {0xA2, 0x17}},  // Gamma 8 /247
    {LCM_SEND(2), {0xA3, 0x0f}},  // Gamma 16 /239
    {LCM_SEND(2), {0xA4, 0x09}},  // Gamma 24 /231
    {LCM_SEND(2), {0xA5, 0x15}},  // Gamma 52 / 203
    ...
    {LCM_SEND(2), {0xAD, 0x2b}},  // Gamma 247 / 8
    {LCM_SEND(2), {0xAE, 0x27}},  // Gamma 251 / 4
    {LCM_SEND(2), {0xAF, 0x00}},  // Gamma 255 / 0

///==============Nagitive
    {LCM_SEND(2), {0xC0, 0x00}},  // Gamma 0 
    {LCM_SEND(2), {0xC1, 0x0c}},  // Gamma 4
    {LCM_SEND(2), {0xC2, 0x17}},  // Gamma 8
    ...
    {LCM_SEND(2), {0xCD, 0x2b}},  // Gamma 247
